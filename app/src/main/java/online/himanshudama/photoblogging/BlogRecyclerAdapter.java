...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String desc = blogPostList.get(position).getDesc();
        ...
        String userId = blogPostList.get(position).getUser_id();
        ...
        firebaseFirestore.collection("Posts/" + blogPostId + "/Likes").document(currentUserId).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                ...
                if(documentSnapshot.exists()){
                    ...
                    holder.likeButton.setImageDrawable(context.getDrawable(R.drawable.ic_like_active));

                } else {

                    holder.likeButton.setImageDrawable(context.getDrawable(R.drawable.ic_like));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setBlogImage(String downloadUri, String thumbUri){
            ...
            blogImageView = mView.findViewById(R.id.blogPostImageView);
        ...
        public void setTime(String date) {
            ...
            blogDate = mView.findViewById(R.id.wallDate);
        ...
        public void setUserData(String name, String image){
            ...
            blogProfileImage = mView.findViewById(R.id.wallProfileImage);
            blogUserName = mView.findViewById(R.id.wallUserName);

            blogUserName.setText(name);

            RequestOptions placeholderOption = new RequestOptions();
            placeholderOption.placeholder(R.drawable.defaultphoto);
